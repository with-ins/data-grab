...
export class 한국노인인력개발원 extends AbstractJob {
    constructor() {
        super('한국노인인력개발원', 'https://www.kordi.or.kr', [new 공지사항(), new 채용()]);
    }
...
class 공지사항 extends SimpleTemplateStep {
    constructor() {
        super('https://www.kordi.or.kr/content.do?cmsId=91', 'tbody tr', Category.NOTICE);
    }
...
class 채용 extends SimpleTemplateStep {
    constructor() {
        super('https://www.kordi.or.kr/content.do?cmsId=170', 'tbody tr', Category.RECRUIT);
    }
