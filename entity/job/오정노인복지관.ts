...
class NoticeStep implements Step {
    ...
    async run(page: Page, syncDate : Date, baseUrl: string): Promise<object> {
        await page.goto('https://senior.bucheon4u.kr/senior/user/bbs/BD_selectBbsList.do?q_bbsCode=1005&q_domnCode=2&q_estnColumn1=0110303&q_searchTy=&q_searchVal=&q_currPage=1&q_sortName=&q_sortOrder=');
        // await page.goto('https://senior.bucheon4u.kr/senior/user/bbs/BD_selectBbsList.do?q_domnCode=2&q_bbsCode=1005');
